              ...
              <tbody className="divide-y divide-gray-200">
                {filteredBooks.map((book) => (
                  <tr key={book.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-gray-900">{book.location}</td>
            ...
            <div className="bg-white rounded-lg p-6 w-full max-w-3xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-gray-800 mb-3">Book Information</h3>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p><strong>Status:</strong> 
                    <span className={`ml-2 px-2 py-1 text-xs font-semibold rounded-full ${
                      selectedBook.available > 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                    }`}>
              ...
              <div className="mt-6 bg-gray-50 p-4 rounded-lg">
                <h3 className="font-semibold text-gray-800 mb-3">Current Issues</h3>
                  ...
                  {issuedBooks.filter(issue => issue.bookTitle === selectedBook.title).map((issue, index) => (
                    <div key={index} className="flex justify-between items-center p-2 bg-white rounded">
                      ...
                      <span className={`px-2 py-1 text-xs font-semibold rounded-full ${
                        issue.status === 'Active' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                      }`}>
                        {issue.status}
                      </span>
                    </div>
