          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl font-bold text-gray-800">Mark Attendance - {selectedDate}</h2>
                <button 
                ...
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {markAttendanceData.map((student) => (
                      <tr key={student.id}>
                        <td className="px-4 py-4 whitespace-nowrap font-medium text-gray-900">{student.rollNo}</td>
                        <td className="px-4 py-4 whitespace-nowrap text-gray-900">{student.student}</td>
                        <td className="px-4 py-4 whitespace-nowrap text-gray-900">{student.course}</td>
        ...
        {showEditModal && selectedStudent && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-2xl">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl font-bold text-gray-800">Edit Attendance - {selectedStudent.student}</h2>
                <button 
        ...
        {showDetailsModal && selectedStudent && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-3xl">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl font-bold text-gray-800">Attendance Details - {selectedStudent.student}</h2>
                <button 
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p><strong>Status:</strong> 
                    <span className={`ml-2 px-2 py-1 text-xs font-semibold rounded-full ${
                      selectedStudent.percentage >= 80 ? 'bg-green-100 text-green-800' :
              ...
              <div className="bg-gray-50 p-4 rounded-lg mb-6">
                <h3 className="font-semibold text-gray-800 mb-3">Recent Attendance (Last 10 Days)</h3>
