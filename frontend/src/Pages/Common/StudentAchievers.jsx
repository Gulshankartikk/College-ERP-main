        ...
        <div className="min-h-screen bg-background font-sans">
                    ...
                    <div className="flex justify-between h-16 items-center">
                        <div className="flex items-center gap-2">
                            <div className="bg-sky-blue/10 p-2 rounded-lg">
                                <FaUserGraduate className="text-sky-blue text-xl" />
                            </div>
                        ...
                        <div className="flex items-center gap-4">
                            <div className="relative group cursor-pointer">
                                <FaBell className="text-text-grey hover:text-sky-blue transition-colors text-xl" />
            ...
            <div className="bg-navy text-white py-16 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
                    <h1 className="text-4xl md:text-5xl font-extrabold mb-4 bg-gradient-to-r from-sky-blue to-white bg-clip-text text-transparent">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {achievers.map((student) => (
                        <div key={student.id} className="group relative">
                            <div className="absolute -inset-0.5 bg-gradient-to-r from-sky-blue to-navy rounded-2xl blur opacity-25 group-hover:opacity-75 transition duration-500"></div>
                            <Card className="relative h-full border-none">
                                <CardContent className="p-8 flex flex-col items-center text-center">
                                    ...
                                    <h3 className="text-xl font-bold text-navy mb-1">{student.name}</h3>
                                    <p className="text-sky-blue font-medium mb-4">{student.course}</p>
                                    ...
                                    <div className="w-full text-left space-y-3 bg-gray-50 p-4 rounded-xl">
                                        <h4 className="text-sm font-bold text-gray-500 uppercase tracking-wider mb-2">Track Record</h4>
                                        {student.achievements.map((achievement, idx) => (
                                            <div key={idx} className="flex items-start gap-2 text-sm text-gray-700">
                                                <FaStar className="text-yellow-400 mt-0.5 flex-shrink-0" size={12} />
