...
const DeleteTeacherFromCourse = () => {
  ...
  useEffect(() => {
    const img = new Image();
    img.src = "/src/assets/dr-ambedkar-institute-of-technology-for-handicapped-kanpur.jpeg";
    img.onload = () => {
      setImageLoaded(true);
    };
  }, []);
          ...
          >
            <div className="w-full flex justify-center items-center">
              <div className="flex items-center justify-center w-52">
                <img
                  src="/src/assets/dr-ambedkar-institute-of-technology-for-handicapped-kanpur.jpeg"
                  alt="logo"
                  className="w-full"
                />
              </div>
