...
import { MdBrowserUpdated, MdAssignment, MdNotifications } from "react-icons/md";
import { FaKey, FaBook, FaStickyNote } from "react-icons/fa";
      ...
      >
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 lg:hidden">
          ...
          <div className="flex items-center space-x-2">
            {id && <NotificationBell userId={id} userRole="student" />}
            <button
              type="button"
